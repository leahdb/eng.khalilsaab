...
function Contact() {
  return (
    <section class="contact section-padding pt-0" id="contact">
      <div class="container">
        <div class="row">
          <div className="mx-auto col-lg-4 col-md-6 col-12"></div>
          ...
          <div class="col-lg-6 col-md-6 col-12">
            ...
            >
              <div class="form-group d-flex flex-column-reverse">
                ...
                <label for="cf-name" class="webform-label">
                  Full Name
                </label>
              </div>
              ...
              <div class="form-group d-flex flex-column-reverse">
                ...
                <label for="cf-email" class="webform-label">
                  Your Email
                </label>
              </div>
              ...
              <div class="form-group d-flex flex-column-reverse">
                ...
                <label for="cf-message" class="webform-label">
                  Message
                </label>
              </div>
              ...
              <Link to="intro">
                <img src={Send} width="170" alt="Eng. Khalil Saab" />
              </Link>
            </form>
          </div>
